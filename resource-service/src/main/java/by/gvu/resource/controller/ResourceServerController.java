...
public class ResourceServerController {
    ...
    public ResponseEntity<Map<String, Long>> uploadMp3(@RequestBody byte[] fileBytes) {
        return ResponseEntity.ok(Map.of("id", mp3ResourceFileFacade.uploadFile(fileBytes)));
    }
